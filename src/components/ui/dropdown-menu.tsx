  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        relative flex cursor-default items-center gap-2 rounded-sm px-4 py-2 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4`,
        className
      )}
      {...props}
    />
